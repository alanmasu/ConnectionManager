...
#define CONN_FIRST_INTERVAL 3000			//Primo scatto del pulsante di connessione
...
#define REBOOT_ON_NOT_RECONNECTION_FOR_TIME false		//Modalita di reboot dopo aver raggiunto il max tentativo di riconnesione
...
public:
	...
	virtual void loop(bool withServer = true, bool withOTA = true);		//ok //Check Connection, reconnect to WiFi in case of losing connection, 
...
protected:
	...
	void _loop(bool withServer = true, bool withOTA = true);		//va finito
	...
	void WiFiEvent(WiFiEvent_t event, system_event_info_t info);	//ok
